...
const requestSignUp = (username, email, password, birthday, dispatches, setErrorMessages, errorMessagesInit, setIsLoading) => {
  setIsLoading(true);
  ...
  axios
    ...
    .then(res => {
      requestSignIn(email, password, dispatches, setErrorMessages, errorMessagesInit, setIsLoading);
    })
    .catch(err => {
